...
import 'package:pt/local_notifications_helper.dart';
import 'package:pt/pages/second_page.dart';
      ...
      children: <Widget>[
        ...
        RaisedButton(
          ...
          onPressed: () => showOngoingNotification(notifications,
              title: 'HeartTutor', body: 'No olvides registrar tu consumo de cigarrillos diario'),
        ),
        RaisedButton(
